...
class TarefaController extends Controller
{
        ...
        return array_merge(
            ...
            [
                'access' => [
                    ...
                    'only' => ['index', 'check', 'update', 'delete'], // Ações protegidas
                    'rules' => [
                        // Regra para utilizadores autenticados
                        [
                            'allow' => true,
                            'actions' => ['index','update' ,'delete'], // Ações restritas
   ...
   //Botao de dar checked à tarefa
    public function actionCheck($feito)
    {
        $this->findModel($feito)->check();
        if ($feito ==0 ){
