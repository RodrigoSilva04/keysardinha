...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown">
            ...
            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                <li><a href="<?= \yii\helpers\Url::to(['desconto/index']) ?>" class="dropdown-item">Descontos</a></li>
                <li><a href="<?= \yii\helpers\Url::to(['cupao/index']) ?>" class="dropdown-item">Cupões</a></li>
            </ul>
        </li>
    </ul>
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item" >
            <?= Html::a('<i class="fas fa-sign-out-alt"></i>', ['/site/logout'], ['data-method' => 'post', 'class' => 'nav-link' , 'id' => 'logout-link']) ?>
        </li>
        <li class="nav-item">
